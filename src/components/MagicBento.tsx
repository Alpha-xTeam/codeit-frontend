...
// مكون مخصص للبطاقات الموجودة في المشروع
export const MagicCard: React.FC<{
  ...
  }, [animateParticles, clearAllParticles, shouldDisableAnimations, enableTilt, enableMagnetism, clickEffect, glowColor]);

  return (
    <div
      ref={cardRef}
      className={`${className} ${enableBorderGlow ? 'magic-card--border-glow' : ''} relative overflow-hidden`}
      style={{
        '--glow-x': '50%',
        '--glow-y': '50%',
        '--glow-intensity': '0',
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  return (
    <>
      ...
      {/* هذا المكون مخصص للاستخدام مع البطاقات الموجودة في المشروع */}
      <div>استخدم MagicCard component بدلاً من MagicBento</div>
    </>
  );
};
